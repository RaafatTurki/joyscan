...
devices = 
{
    ...
    -- kbd0 = "/dev/input/by-id/usb-SONiX_USB_DEVICE-event-kbd",
    kbd0 = "/dev/input/by-id/usb-0c76_RAMPAGE_MIRACLE-event-if03"
    -- kbd1 = "/dev/input/by-id/usb-Aqua_Computer_GmbH___Co._KG_aquaero_07538-20376-event-kbd" -- another keyboard device example
    -- kbd1 = "/dev/input/by-id/usb-ZhiXu_Controller_1187A89-joystick",
}
